...
5. **UX release gate על אותו מסדרון: HOLD** — 4 ממצאי P0, כולם בפורטל בלבד ומאמץ קטן: לוח Today לא מקשר ל-"Needs a report" ולשורות התוכנית; enum גולמי בטופס הישן; יעדי מגע 28–56px במסדרון `/production` מול הנעילה ≥60px. איכות המסכים כשלעצמם טובה — הכשלים בתפרים בין המסכים ובמשטח הישן. פירוט: `docs/phase8/dry-runs/2026-09-19-ux-release-gate-planning-chain.md`.
