...
**STATUS: SHIPPED 2026-09-24 — https://github.com/tomw200082-collab/gt-factory-os/pull/276 and https://github.com/tomw200082-collab/gt-factory-os-portal/pull/227 merged; this stamp ships in https://github.com/tomw200082-collab/gt-factory-os-production-brain/pull/208. Deploy https://github.com/tomw200082-collab/gt-factory-os/actions/runs/35885702775: 0350 applied, post-check `rebuild_verifier()=0`, new API live 2026-09-23 16:03 UTC. Portal deployment `dpl_H2ozu7gxTY8DBxrEYQ1dP911HDEN` READY. First live proposal `2ff6f479-cbbc-4d9c-90d6-080c9c81f253` (task 28069095, question only). D4 closed 2026-09-24 by https://github.com/tomw200082-collab/gt-factory-os/pull/281 (Tom delegated the call): migration 0352 removed GI-20269's 4 unposted lines (ledger id NULL), each raised as a notice in deploy https://github.com/tomw200082-collab/gt-factory-os/actions/runs/35988491173; pre/post `rebuild_verifier()=0`; the D4 falsifier returns 0 rows; `db/tests/0352` 4/4 in prod. Still open: D9 — no candidate in the live window has had derivable lines yet. Tom declined to re-enable the daily-ops-guardian Routine (2026-09-24), so the sweep moved into the API: https://github.com/tomw200082-collab/gt-factory-os/pull/278, pg_cron `stock_exceptions_sweep` (job 36) daily 03:30 UTC, first live API run `859c5e9c` 2026-09-24 07:02 UTC succeeded; the first daily run with such a candidate closes D9. https://github.com/tomw200082-collab/gt-factory-os/pull/279 made a Green Invoice failure an open question and added a LionWheel 429 retry. Green Invoice keys copied to Railway from the repository secrets by https://github.com/tomw200082-collab/gt-factory-os/pull/280 (Tom's yes, 2026-09-24). The production backtest run `d189474a` reproduces the Python backtest: 81/81 proposals, 71 lines. D10 (Tom's) — reject the 4 stale proposals in the portal.**
