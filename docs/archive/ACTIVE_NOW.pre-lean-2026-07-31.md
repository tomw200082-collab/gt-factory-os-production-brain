...
**Last refreshed:** 2026-07-23 (factory-mapping v3 rollout). See `CURRENT_STATE.md` §"Factory-mapping v3 rollout — org model → operating system (2026-07-22/23)" for full detail: operating model + playbook v2 (in force, v1 archived) + station cards/briefing, skill upgrades (route calendar + Maiden default driver + guardian Stage 0.5 / queue-guard / sunday-prep, PR #51), portal tranches 136/137/138 (PRs #178/#177/#180), backend T8 + G1 view (PRs #176/#178 — **G1 migration 0287 applied to prod & live-verified 23.7**), 3 self-bound Routines running (Thu queue-guard, Sat sunday-prep, Sun scorecard). **Open (Tom, non-blocking):** Maxim's portal user; Alex conversation (pack ready). Reference PR numbers — local mains lag the GitHub squash-merges.

**Prior refresh (2026-07-17, procurement corridor):** backend migrations 0284-0286 (`gt-factory-os` PRs #170/#171), portal tranches 132-133 (`gt-factory-os-portal` PRs #172/#173), procurement-planning skill upgrades (this repo, PRs #41/#42) — all merged and live-verified.
