...
In production (API on Railway, dry-run `d189474a`, 2026-09-24) the results match again: the same counts, 81/81 proposals, 71 lines, 14 credit links. The only differences are the Green Invoice download tokens and the order of tied credit tasks inside two questions.
