...
description: >
  ...
  scheduled routine "דוח מכירות שבועי" (Sunday 08:00 IL), or when Tom says
...
שפת עבודה: **עברית**. המטרה: בכל ראשון בבוקר (08:00, תום 2026-08-30) הדוח מעודכן
והלינק אצל תום במייל, עם שעה מדויקת של טריות הנתונים — הפגישה השבועית (רביעי) רצה
סביב הקובץ הזה, והוא מגיע מוכן מתחילת השבוע.
